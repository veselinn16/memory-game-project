function main() {
    ...
    // CLASSES ARRAY
    const $classes = ['<i class="card__symbol icon-basic-clubs"></i><span>a</span>', '<i class="card__symbol icon-basic-clubs"></i><span>a</span>', '<i class="card__symbol icon-basic-heart"></i><span>b</span>', '<i class="card__symbol icon-basic-heart"></i><span>b</span>', '<i class="card__symbol icon-basic-diamonds"></i><span>c</span>', '<i class="card__symbol icon-basic-diamonds"></i><span>c</span>', '<i class="card__symbol icon-basic-spades"></i><span>d</span>', '<i class="card__symbol icon-basic-spades"></i><span>d</span>', '<i class="card__symbol icon-basic-signs"></i><span>e</span>', '<i class="card__symbol icon-basic-signs"></i><span>e</span>', '<i class="card__symbol icon-basic-helm"></i><span>f</span>', '<i class="card__symbol icon-basic-helm"></i><span>f</span>', '<i class="card__symbol icon-basic-flag1"></i><span>g</span>', '<i class="card__symbol icon-basic-flag1"></i><span>g</span>', '<i class="card__symbol icon-basic-globe"></i><span>h</span>', '<i class="card__symbol icon-basic-globe"></i><span>h</span>'];
